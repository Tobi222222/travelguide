<script lang="ts">
    ...
    const profileDetails: Record<string, { desc: string, icon: any, color: string, heroImage: string, fallback: string }> = {
        'Foodie Explorer': {
            ...
            fallback: 'https://images.unsplash.com/photo-1550966871-3ed3cdb5ed0c?w=1600'
        },
        'Hidden Gem Hunter': {
            ...
            fallback: 'https://images.unsplash.com/photo-1549449830-ecb8b3b3ba98?w=1600'
        },
        'Luxury Traveler': {
            ...
            fallback: 'https://images.unsplash.com/photo-1534008897995-27a23e859048?w=1600'
        },
        'Beach Lover': {
            ...
            fallback: 'https://images.unsplash.com/photo-1519046904884-53103b34b206?w=1600'
        },
        'Party Traveler': {
            ...
            fallback: 'https://images.unsplash.com/photo-1574096079513-d8225ba67711?w=1600'
        },
        'Local Lifestyle Explorer': {
            ...
            fallback: 'https://images.unsplash.com/photo-1495474472205-162847d15532?w=1600'
        },
        'Culture Lover': {
