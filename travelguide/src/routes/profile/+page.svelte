            ...
            <div class="md:col-span-3">
                ...
                {:else}
                    <div class="bg-white rounded-3xl p-8 shadow-sm border border-cream-200 text-center">
                        ...
                        <a href="{base}/quiz" class="inline-block px-8 py-3.5 bg-terracotta-500 text-white font-semibold rounded-full hover:bg-terracotta-600 transition-all duration-300 shadow-md hover:shadow-lg active:scale-95">
                            Take the Quiz
                        </a>
                    </div>
                {/if}
